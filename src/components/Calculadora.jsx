        ...
        <div className="calculadora-content">
          ...
          <div className="links-governamentais">
            ...
            <div className="links-grid">
              ...
              <div className="link-card">
                <h5>📄 DASN-SIMEI (Alternativo)</h5>
                <p>Declaração Anual MEI via Portal do Empreendedor</p>
                <a 
                  href="https://www.portaldoempreendedor.gov.br/temas/quero-ser/formalize-se/dasn-simei" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="btn-link"
                >
